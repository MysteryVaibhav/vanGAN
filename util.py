...
def get_train_dict():
    return np.load(DATA_DIR + 'training.npy').item()


def get_seed_dict():
    return np.load(DATA_DIR + 'seed.npy').item()
...
if __name__ == '__main__':
    ...
    seed_lexicon = get_validation_set(SEED_LEXICON, save=True,
                                   save_file_as='seed')
    print(seed_lexicon)
    print(len(seed_lexicon.keys()))
